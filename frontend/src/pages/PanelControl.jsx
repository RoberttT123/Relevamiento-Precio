  ...
  function exportarXLSX(filas, periodo) {
    ...
    const rows = filas.map(r => {
      ...
      return {
        ...
        "Margen Caja %":      r.margen_caja_pct   != null ? `${r.margen_caja_pct.toFixed(1)}%`   : "",
        ...
        "Margen Ud. %":       r.margen_unidad_pct != null ? `${r.margen_unidad_pct.toFixed(1)}%` : "",
        "Margen Unidad (Bs)": r.margen_unidad_bs  != null ? parseFloat(r.margen_unidad_bs.toFixed(2))  : "",
        "Precio x Gr/ML":     precioPorGrMl,
        "Index Real":         r.index_real  != null ? `${Math.round(r.index_real)}%` : "",
